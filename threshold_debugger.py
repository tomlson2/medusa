...
while True:
    ...
    edited_image = cv.putText(edited_image,"Threshold = " + str(round(threshold,4)),(200,40),cv.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)
    edited_image = cv.putText(edited_image,"Matches = " + str(len([])),(200,85),cv.FONT_HERSHEY_COMPLEX,1,(0,255,0),2)                
